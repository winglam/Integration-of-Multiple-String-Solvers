...
string solvers: \CodeIn{HAMPI}, \CodeIn{DPRLE}, \CodeIn{Z3str} to solve string
...
translate each tree node into a string format of each language. If a solver language doesn't support
